...
<div id="fmcode" class="w3-modal" style="display:<?php echo $fmcode; ?>">
  ...
  <div class="w3-center w3-centered w3-container w3-padding-medium w3-border-bottom" style="align-content:center;margin-bottom:32px">
    ...
    <div class="w3-third w3-container w3-margin-bottom">
        <div class=" w3-white w3-container"><p class="w3-center"><b><?php echo $val['title'] ?></b></p></div>
<a class="example-image-link" href="assets/img/<?php echo $val['gid'] ?>.jpg" data-lightbox="same" data-title="<?php echo $val['title'] ?>"><img class="example-image" src="assets/img/<?php echo $val['gid'] ?>.jpg" alt="<?php echo $val['title'] ?>" style="height: 280px; width:100%" class="w3-hover-opacity"/></a>
      <div class="w3-container w3-white">
		...
		<table style="width: 100%;">
					...
					<td><i id="<?php echo $val['gid'] ?>" class="like w3-btn w3-grey w3-circle fa fa-thumbs-up w3-xlarge" onclick="changelike(this.id);"></i></td>
					<td><span id="t<?php echo $val['gid'] ?>">0</span><span id="s<?php echo $val['gid'] ?>"> like</span></td>
					</tr>
			</table>
				</div>
      </div>
